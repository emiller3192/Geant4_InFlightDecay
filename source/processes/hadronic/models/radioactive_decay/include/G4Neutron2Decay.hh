...
#ifndef G4Neutron2Decay_h
#define G4Neutron2Decay_h 1

#include "G4NuclearDecay.hh"


class G4Neutron2Decay : public G4NuclearDecay
{
  public:
    G4Neutron2Decay(const G4ParticleDefinition* theParentNucleus,
                  const G4double& theBR, const G4double& Qvalue,
                  const G4double& excitation);

    virtual ~G4Neutron2Decay();
