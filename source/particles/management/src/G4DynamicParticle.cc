...
//      revised by E. Miller .......11 May 2020
//         Preassigned decay times for all relavant constructors
//--------------------------------------------------------------
...
//include randomize to sample decay curve
...
//functions added by E. Miller in May 2020 for preassigning decay times
G4double G4DynamicParticle::CalcRandomDecayTime()
{
  ...
  if (theParticleDefinition != NULL) {
    ...
    G4cout << "ERROR:   Particle def. is null. Could cause strange results." << G4endl;
    return DBL_MAX;
  }
}
